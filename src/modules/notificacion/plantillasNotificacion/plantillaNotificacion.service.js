...
En  * @param {Record<string, string|number|null|undefined>} datos - Mapa de variables a valores reales. Keys en mayúsculas (ej. NOMBRE_POSTULANTE, LINK).
 * @returns {Promise<{ asunto: string, cuerpo: string, plantillaId: string }|null>} Contenido renderizado o null si no hay plantilla activa
 */
